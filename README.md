...
composeApp/src/commonMain/kotlin/app/reseam/manager/platform  platform contracts (HTTP, installed apps, installing)
...
4. Platform adapters do HTTP, file picking, and installation. Android and desktop differences stay there.
